...
function set_profile_pic() {
    const userImgs = document.querySelectorAll("div.user_img");
    userImgs.forEach(function(userImg) {
        const profilePictureUrl = userImg.getAttribute("data-image");
        userImg.style.backgroundImage = `url(../static/com/img/${profilePictureUrl})`;
    });
}
...
window.addEventListener('DOMContentLoaded', function(){
    ...
    document.getElementById('chatting_room_detail').style.display = 'none';
});
